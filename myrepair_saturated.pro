...
;	endif else  temp = template
        temp = template
        extract_overlap, star, temp, round(star_ref), temp_ref, $
   	...
   	x = x + lx  &  y = y + ly
        ...
        WT[*,*] = 0
        WT[w] = 1
        res = mpcurvefit(temp,star,WT,P,sigma,FUNCTION_NAME='PSFFIT',/NODERIVATIVE) ;,/QUIET)
        print, P
        ; Repair image
...
PRO myrepair_saturated, image, clean_image, background, psf, psf_fwhm, x, y, $
