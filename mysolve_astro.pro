...
FUNCTION mysolve_astro,radeg,decdeg,xpixel,ypixel,XIORDER=xiorder,ETAORDER=etaorder,XTERMS=xterms,$
...
IF (ndata LE 5)THEN BEGIN
   PRINT,'WARNING in solve_astro: xpixel/ypixel/radeg/decdeg should contain at least 6 objects.'
ENDIF
